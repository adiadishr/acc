    ...
    <section className="bg-black pb-52">
        <div className="container mx-auto px-3 md:px-10">
            <div className="px-5 py-32">
                <p className="text-3xl text-white w-8/12 pb-24 leading-[3.5rem]">
                ...
                <ul className="text-2xl flex flex-col gap-4 text-gray-200/95 list-disc list-inside">
                    <li>
                        Intercollege and Intra-college competition
                    </li>
                    <li>
