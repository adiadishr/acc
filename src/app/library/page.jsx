...
export default function LibraryPage() {
    ...
    useEffect(() => {
        const drawFirstFloor = () => {
            ...
            ctx.fill();
            ctx.fillStyle = '#000';
            ctx.fillText('Sleeping Area Girls 104', 350, 125);
            ...
            ctx.fill();
            ctx.fillStyle = '#000';
            ctx.fillText('Server Room 103', 700, 125);

            // Draw middle Sleeping Area
            ctx.beginPath();
            ctx.rect(420, 220, 150, 100);
            ctx.stroke();
            ctx.fillStyle = '#f4f4f4';
            ctx.fill();
            ctx.fillStyle = '#000';
            ctx.fillText('Sleeping Area Boys 101', 495, 270);
            ...
            ctx.fill();
            ctx.fillStyle = '#000';
            ctx.fillText('Sleeping Area Boys 102', 495, 415);
        ...
        const drawSecondFloor = () => {
            ...
            ctx.fill();
            ctx.fillStyle = '#000';
            ctx.fillText('Recreation Room 105', 350, 150);
